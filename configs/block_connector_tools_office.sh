#!/bin/bash
#SBATCH --job-name=connector_tools_office
...
RUN_NAME="connector_${DATASET}_${OPT}"
...
echo "Command: python run_recbole.py -d ${DATASET} -m ContGCN --opt ${OPT}"

python run_recbole.py -d "${DATASET}" -m ContGCN --opt "${OPT}"
